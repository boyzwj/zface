...
from models.load_mats import transferBFM09
import os
...
class ParametricFaceModel:
    ...
    def compute_shape(self, id_coeff, exp_coeff):
        ...
        id_part = torch.einsum('ij,aj->ai', self.id_base, id_coeff.float())
        exp_part = torch.einsum('ij,aj->ai', self.exp_base, exp_coeff.float())
