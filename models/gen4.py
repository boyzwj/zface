...
class AdaIN(nn.Module):
    def __init__(self,channel,style_dim = 256):
        super().__init__()
        self.channel = channel
        self.style1 = nn.Linear(style_dim, channel)
        self.style2 = nn.Linear(style_dim, channel)
...
class AdaInUpBlock(nn.Module):
    def __init__(self,channel,style_dim = 256,up_sample=True):
        super().__init__()
...
#         self.d5 = GenResBlk(512, 128, up_sample=True, style_dim=style_dim,activation=activation)     
...
#         self.u1 = GenResBlk(128, 64,  up_sample=True, style_dim=style_dim,activation=activation,return_rgb=True)
